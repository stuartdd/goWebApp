...
func TestFastFile(t *testing.T) {
	...
	r, respBody := RunClientGet(t, "TestFastFile 1", configData, url, 200, "?", -1, 10)
	AssertEquivilent(t, "TestFastFile 1", respBody, "{\"Data\":\"This is the data for 2\"}")
	...
	r, respBody = RunClientGet(t, "TestFastFile 2", configData, url, 200, "?", -1, 10)
	AssertEquivilent(t, "TestFastFile 2", respBody, "{\"Data\":\"This is the data for 2\"}")
...
func TestFastFileErrors(t *testing.T) {
	...
	r, respBody := RunClientGet(t, "TestFastFileErrors 1", configData, url, 400, "?", -1, 10)
	...
	_, respBody = RunClientGet(t, "TestFastFileErrors 2", configData, url, 404, "?", -1, 10)
	...
	_, respBody = RunClientGet(t, "TestFastFileErrors 3", configData, url, 404, "?", -1, 10)
	...
	_, respBody = RunClientGet(t, "TestFastFileErrors 4", configData, url, 404, "?", -1, 10)
	...
	_, respBody = RunClientGet(t, "TestFastFileErrors 5", configData, url, 404, "?", -1, 10)
	...
	_, respBody = RunClientGet(t, "TestFastFileErrors 6", configData, url, 404, "?", -1, 10)
	...
	_, respBody = RunClientGet(t, "TestFastFileErrors 7", configData, url, 404, "?", -1, 10)
	...
	_, respBody = RunClientGet(t, "TestFastFileErrors 8", configData, url, 404, "?", -1, 10)
	...
	_, respBody = RunClientGet(t, "TestFastFileErrors 9", configData, url, 404, "?", -1, 10)
	...
	_, respBody = RunClientGet(t, "TestFastFileErrors 10", configData, url, 404, "?", -1, 10)
