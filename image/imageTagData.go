...
var mapTags = map[uint32]*Tag{
	...
	36864: newExifTagData(false, 36864, "ExifVersion", []TiffFormat{FormatString}, "4", 4, "Exif version number. Stored as 4bytes of ASCII character (like 0210) "),
	...
	40960: newExifTagData(false, 40960, "FlashpixVersion", []TiffFormat{FormatString}, "4", 4, "*AltName(FlashPixVersion) Stores FlashPix version. Unknown but 4bytes of ASCII characters '0100' exists. "),
	...
	37510: newExifTagData(false, 37510, "UserComment", []TiffFormat{FormatString}, "N", -1, "Stores user comment. "),
