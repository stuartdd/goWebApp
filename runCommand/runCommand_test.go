...
func TestNoCommands(t *testing.T) {
	tc := NewExecData([]string{}, "..", "../testdata/logs/cmdout.txt", "../testdata/logs/cmderr.txt", "info", false, nil, nil)
	_, _, _, err := tc.Run()
	if err == nil {
...
func TestLs(t *testing.T) {
	tc := NewExecData([]string{"ls", "-lta"}, "..", "../testdata/logs/cmdout-ls.txt", "../testdata/logs/cmderr-ls.txt", "info", false, nil, nil)
...
func TestLsErr(t *testing.T) {
	tc := NewExecData([]string{"ls", "-lta", "x"}, "..", "../testdata/logs/cmdout-ls-x.txt", "../testdata/logs/cmderr-ls-x.txt", "info", false, nil, nil)
...
func TestPWD(t *testing.T) {
	...
	tc := NewExecData([]string{"pwd"}, "..", "../testdata/logs/cmdout-pwd.txt", "../testdata/logs/cmderr-pwd.txt", "info", false, nil, nil)
	stdOut, _, _, err := tc.Run()
	if err != nil {
		t.Fatalf("Error:%e", err)
	}
...
func TestGo(t *testing.T) {
	...
	tc := NewExecData([]string{"go", "version"}, "", "../testdata/logs/cmdout-go.txt", "../testdata/logs/cmderr-go.txt", "info", false, nil, nil)
	stdOut, _, _, err := tc.Run()
	if err != nil {
		t.Fatalf("Error:%e", err)
	}
